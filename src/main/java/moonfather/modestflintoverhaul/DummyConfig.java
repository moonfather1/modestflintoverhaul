...
//            .define("Dispenser override - disable", defaultDispenserOverrideToDisable);
    ...
    public static boolean DispenserOverrideToEnable = false;
    public static boolean DispenserOverrideToDisable = false;
    public static int BaseDropChance = 30;
    public static int Fortune1Chance = 40;
    public static int Fortune2Chance = 90;
